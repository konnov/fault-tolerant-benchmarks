...
#define all_acc ((((((Proc0I__pc == 3) && (Proc1I__pc == 3)) && (Proc2I__pc\
  == 3)) && (Proc3I__pc == 3))))
#define in_transit ((((((Proc0I__nrcvd < ((nsnt + 6) + 1)) || (Proc1I__nrcvd\
  < ((nsnt + 6) + 1))) || (Proc2I__nrcvd < ((nsnt + 6) + 1))) ||\
  (Proc3I__nrcvd < ((nsnt + 6) + 1)))))
#define tx_inv (((0 == nsnt)))
#define symm_inv (((((0 == 0) && (nsnt >= 0)) || ( ! ((nsnt + 6) < 9)))))
/* (N > 3) */
/* (Fss >= 0) */
/* (Fsp >= 0) */
/* (Fa >= 0) */
