...
#define delivered ((((((((((((Proc0I__nrcvd >= (nsnt + 0)) && (Proc1I__nrcvd\
  >= (nsnt + 0))) && (Proc2I__nrcvd >= (nsnt + 0))) && (Proc3I__nrcvd >=\
  (nsnt + 0))) && (Proc4I__nrcvd >= (nsnt + 0))) && (Proc5I__nrcvd >= (nsnt +\
  0))) && (Proc6I__nrcvd >= (nsnt + 0))) && (Proc7I__nrcvd >= (nsnt + 0))) &&\
  (Proc8I__nrcvd >= (nsnt + 0))) && (Proc9I__nrcvd >= (nsnt + 0)))))
