...
#define ex_acc ((((((((((((Proc0I__pc == 3) || (Proc1I__pc == 3)) ||\
  ...
  (Proc8I__pc == 3)) || (Proc9I__pc == 3))))
#define all_acc ((((((((((((Proc0I__pc == 3) && (Proc1I__pc == 3)) &&\
  (Proc2I__pc == 3)) && (Proc3I__pc == 3)) && (Proc4I__pc == 3)) &&\
  (Proc5I__pc == 3)) && (Proc6I__pc == 3)) && (Proc7I__pc == 3)) &&\
  (Proc8I__pc == 3)) && (Proc9I__pc == 3))))
#define in_transit ((((((((((((Proc0I__nrcvd < (nsnt - 3)) || (Proc1I__nrcvd\
  < (nsnt - 3))) || (Proc2I__nrcvd < (nsnt - 3))) || (Proc3I__nrcvd < (nsnt -\
  3))) || (Proc4I__nrcvd < (nsnt - 3))) || (Proc5I__nrcvd < (nsnt - 3))) ||\
  (Proc6I__nrcvd < (nsnt - 3))) || (Proc7I__nrcvd < (nsnt - 3))) ||\
  (Proc8I__nrcvd < (nsnt - 3))) || (Proc9I__nrcvd < (nsnt - 3)))))
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ((Proc0I__next_nrcvd >= 8) || ((Proc0I__next_nrcvd >= 10) &&
                (Proc0I__next_nrcvd <= 6)));
              Proc0I__next_pc = 3;
          ::  ((Proc0I__next_nrcvd < 8) && ((Proc0I__pc == 1) ||
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc1I__next_nrcvd <= (nsnt + 3)));
              Proc1I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc1I__next_nrcvd >= 8) || ((Proc1I__next_nrcvd >= 10) &&
                (Proc1I__next_nrcvd <= 6)));
              Proc1I__next_pc = 3;
          ::  ((Proc1I__next_nrcvd < 8) && ((Proc1I__pc == 1) ||
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc2I__next_nrcvd <= (nsnt + 3)));
              Proc2I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc2I__next_nrcvd >= 8) || ((Proc2I__next_nrcvd >= 10) &&
                (Proc2I__next_nrcvd <= 6)));
              Proc2I__next_pc = 3;
          ::  ((Proc2I__next_nrcvd < 8) && ((Proc2I__pc == 1) ||
                (Proc2I__next_nrcvd >= 3)));
              Proc2I__next_pc = 2;
            :: else ->
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc3I__next_nrcvd <= (nsnt + 3)));
              Proc3I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc3I__next_nrcvd >= 8) || ((Proc3I__next_nrcvd >= 10) &&
                (Proc3I__next_nrcvd <= 6)));
              Proc3I__next_pc = 3;
          ::  ((Proc3I__next_nrcvd < 8) && ((Proc3I__pc == 1) ||
                (Proc3I__next_nrcvd >= 3)));
              Proc3I__next_pc = 2;
            :: else ->
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc4I__next_nrcvd <= (nsnt + 3)));
              Proc4I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc4I__next_nrcvd >= 8) || ((Proc4I__next_nrcvd >= 10) &&
                (Proc4I__next_nrcvd <= 6)));
              Proc4I__next_pc = 3;
          ::  ((Proc4I__next_nrcvd < 8) && ((Proc4I__pc == 1) ||
                (Proc4I__next_nrcvd >= 3)));
              Proc4I__next_pc = 2;
            :: else ->
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc5I__next_nrcvd <= (nsnt + 3)));
              Proc5I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc5I__next_nrcvd >= 8) || ((Proc5I__next_nrcvd >= 10) &&
                (Proc5I__next_nrcvd <= 6)));
              Proc5I__next_pc = 3;
          ::  ((Proc5I__next_nrcvd < 8) && ((Proc5I__pc == 1) ||
                (Proc5I__next_nrcvd >= 3)));
              Proc5I__next_pc = 2;
            :: else ->
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc6I__next_nrcvd <= (nsnt + 3)));
              Proc6I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc6I__next_nrcvd >= 8) || ((Proc6I__next_nrcvd >= 10) &&
                (Proc6I__next_nrcvd <= 6)));
              Proc6I__next_pc = 3;
          ::  ((Proc6I__next_nrcvd < 8) && ((Proc6I__pc == 1) ||
                (Proc6I__next_nrcvd >= 3)));
              Proc6I__next_pc = 2;
            :: else ->
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc7I__next_nrcvd <= (nsnt + 3)));
              Proc7I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc7I__next_nrcvd >= 8) || ((Proc7I__next_nrcvd >= 10) &&
                (Proc7I__next_nrcvd <= 6)));
              Proc7I__next_pc = 3;
          ::  ((Proc7I__next_nrcvd < 8) && ((Proc7I__pc == 1) ||
                (Proc7I__next_nrcvd >= 3)));
              Proc7I__next_pc = 2;
            :: else ->
...
_lab11:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc8I__next_nrcvd <= (nsnt + 3)));
              Proc8I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc8I__next_nrcvd >= 8) || ((Proc8I__next_nrcvd >= 10) &&
                (Proc8I__next_nrcvd <= 6)));
              Proc8I__next_pc = 3;
          ::  ((Proc8I__next_nrcvd < 8) && ((Proc8I__pc == 1) ||
                (Proc8I__next_nrcvd >= 3)));
              Proc8I__next_pc = 2;
            :: else ->
...
_lab11:
  if
    ::  atomic {
        Proc9I__next_nrcvd = (Proc9I__nrcvd + 1);
        if
          ::  ( ! (Proc9I__next_nrcvd <= (nsnt + 3)));
              Proc9I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  ((Proc9I__next_nrcvd >= 8) || ((Proc9I__next_nrcvd >= 10) &&
                (Proc9I__next_nrcvd <= 6)));
              Proc9I__next_pc = 3;
          ::  ((Proc9I__next_nrcvd < 8) && ((Proc9I__pc == 1) ||
                (Proc9I__next_nrcvd >= 3)));
              Proc9I__next_pc = 2;
            :: else ->
Proc9I__next_pc = Proc9I__pc;
        ...
        Proc9I__nrcvd = Proc9I__next_nrcvd;
        printf("STEP: pc=%d; nrcvd=%d; nsnt=%d\n", Proc9I__pc, Proc9I__nrcvd,
          nsnt);
        Proc9I__next_pc = 0;
        Proc9I__next_nrcvd = 0;
      }
