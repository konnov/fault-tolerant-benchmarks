...
#define prec_no1 ((((((((Proc0I__pc != 1) && (Proc1I__pc != 1)) &&\
  ...
  (Proc5I__pc != 1))))
#define ex_acc0 ((((((((Proc0I__pc == 6) || (Proc1I__pc == 6)) || (Proc2I__pc\
  == 6)) || (Proc3I__pc == 6)) || (Proc4I__pc == 6)) || (Proc5I__pc == 6))))
#define ex_acc1 ((((((((Proc0I__pc == 7) || (Proc1I__pc == 7)) || (Proc2I__pc\
  == 7)) || (Proc3I__pc == 7)) || (Proc4I__pc == 7)) || (Proc5I__pc == 7))))
#define prec_init ((((init0 + init1) == 6)))
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc0I__pc == 3) || (Proc0I__pc == 4));
              Proc0I__next_pc = 5;
          ::  ((Proc0I__pc == 5) && (Proc0I__next_nrcvd10 >= 3));
              Proc0I__next_pc = 6;
          ::  ((Proc0I__pc == 5) && (Proc0I__next_nrcvd11 >= 3));
              Proc0I__next_pc = 7;
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc1I__pc == 3) || (Proc1I__pc == 4));
              Proc1I__next_pc = 5;
          ::  ((Proc1I__pc == 5) && (Proc1I__next_nrcvd10 >= 3));
              Proc1I__next_pc = 6;
          ::  ((Proc1I__pc == 5) && (Proc1I__next_nrcvd11 >= 3));
              Proc1I__next_pc = 7;
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc2I__pc == 3) || (Proc2I__pc == 4));
              Proc2I__next_pc = 5;
          ::  ((Proc2I__pc == 5) && (Proc2I__next_nrcvd10 >= 3));
              Proc2I__next_pc = 6;
          ::  ((Proc2I__pc == 5) && (Proc2I__next_nrcvd11 >= 3));
              Proc2I__next_pc = 7;
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc3I__pc == 3) || (Proc3I__pc == 4));
              Proc3I__next_pc = 5;
          ::  ((Proc3I__pc == 5) && (Proc3I__next_nrcvd10 >= 3));
              Proc3I__next_pc = 6;
          ::  ((Proc3I__pc == 5) && (Proc3I__next_nrcvd11 >= 3));
              Proc3I__next_pc = 7;
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc4I__pc == 3) || (Proc4I__pc == 4));
              Proc4I__next_pc = 5;
          ::  ((Proc4I__pc == 5) && (Proc4I__next_nrcvd10 >= 3));
              Proc4I__next_pc = 6;
          ::  ((Proc4I__pc == 5) && (Proc4I__next_nrcvd11 >= 3));
              Proc4I__next_pc = 7;
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc5I__pc == 3) || (Proc5I__pc == 4));
              Proc5I__next_pc = 5;
          ::  ((Proc5I__pc == 5) && (Proc5I__next_nrcvd10 >= 3));
              Proc5I__next_pc = 6;
          ::  ((Proc5I__pc == 5) && (Proc5I__next_nrcvd11 >= 3));
              Proc5I__next_pc = 7;
