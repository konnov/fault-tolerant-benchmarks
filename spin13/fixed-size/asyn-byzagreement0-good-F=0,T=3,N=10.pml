...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc0I__nrcvde < (nsnte + 0));
              Proc0I__next_nrcvde = (Proc0I__nrcvde + 1);
          ::  Proc0I__next_nrcvde = Proc0I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc0I__next_nrcvde <= 10));
        if
          ::  (Proc0I__nrcvdr < (nsntr + 0));
              Proc0I__next_nrcvdr = (Proc0I__nrcvdr + 1);
          ::  Proc0I__next_nrcvdr = Proc0I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc0I__next_nrcvdr <= 10));
        if
          ::  (Proc0I__pc == 1);
              Proc0I__next_pc = 2;
          ::  ((Proc0I__pc == 0) && ((Proc0I__next_nrcvde >= 7) ||
                (Proc0I__next_nrcvdr >= 4)));
              Proc0I__next_pc = 2;
          ::  ((Proc0I__pc == 2) && ((Proc0I__next_nrcvde >= 7) ||
                (Proc0I__next_nrcvdr >= 4)));
              Proc0I__next_pc = 3;
          ::  ((Proc0I__pc == 3) && (Proc0I__next_nrcvdr >= 7));
              Proc0I__next_pc = 4;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc1I__nrcvde < (nsnte + 0));
              Proc1I__next_nrcvde = (Proc1I__nrcvde + 1);
          ::  Proc1I__next_nrcvde = Proc1I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc1I__next_nrcvde <= 10));
        if
          ::  (Proc1I__nrcvdr < (nsntr + 0));
              Proc1I__next_nrcvdr = (Proc1I__nrcvdr + 1);
          ::  Proc1I__next_nrcvdr = Proc1I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc1I__next_nrcvdr <= 10));
        if
          ::  (Proc1I__pc == 1);
              Proc1I__next_pc = 2;
          ::  ((Proc1I__pc == 0) && ((Proc1I__next_nrcvde >= 7) ||
                (Proc1I__next_nrcvdr >= 4)));
              Proc1I__next_pc = 2;
          ::  ((Proc1I__pc == 2) && ((Proc1I__next_nrcvde >= 7) ||
                (Proc1I__next_nrcvdr >= 4)));
              Proc1I__next_pc = 3;
          ::  ((Proc1I__pc == 3) && (Proc1I__next_nrcvdr >= 7));
              Proc1I__next_pc = 4;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc2I__nrcvde < (nsnte + 0));
              Proc2I__next_nrcvde = (Proc2I__nrcvde + 1);
          ::  Proc2I__next_nrcvde = Proc2I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc2I__next_nrcvde <= 10));
        if
          ::  (Proc2I__nrcvdr < (nsntr + 0));
              Proc2I__next_nrcvdr = (Proc2I__nrcvdr + 1);
          ::  Proc2I__next_nrcvdr = Proc2I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc2I__next_nrcvdr <= 10));
        if
          ::  (Proc2I__pc == 1);
              Proc2I__next_pc = 2;
          ::  ((Proc2I__pc == 0) && ((Proc2I__next_nrcvde >= 7) ||
                (Proc2I__next_nrcvdr >= 4)));
              Proc2I__next_pc = 2;
          ::  ((Proc2I__pc == 2) && ((Proc2I__next_nrcvde >= 7) ||
                (Proc2I__next_nrcvdr >= 4)));
              Proc2I__next_pc = 3;
          ::  ((Proc2I__pc == 3) && (Proc2I__next_nrcvdr >= 7));
              Proc2I__next_pc = 4;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc3I__nrcvde < (nsnte + 0));
              Proc3I__next_nrcvde = (Proc3I__nrcvde + 1);
          ::  Proc3I__next_nrcvde = Proc3I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc3I__next_nrcvde <= 10));
        if
          ::  (Proc3I__nrcvdr < (nsntr + 0));
              Proc3I__next_nrcvdr = (Proc3I__nrcvdr + 1);
          ::  Proc3I__next_nrcvdr = Proc3I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc3I__next_nrcvdr <= 10));
        if
          ::  (Proc3I__pc == 1);
              Proc3I__next_pc = 2;
          ::  ((Proc3I__pc == 0) && ((Proc3I__next_nrcvde >= 7) ||
                (Proc3I__next_nrcvdr >= 4)));
              Proc3I__next_pc = 2;
          ::  ((Proc3I__pc == 2) && ((Proc3I__next_nrcvde >= 7) ||
                (Proc3I__next_nrcvdr >= 4)));
              Proc3I__next_pc = 3;
          ::  ((Proc3I__pc == 3) && (Proc3I__next_nrcvdr >= 7));
              Proc3I__next_pc = 4;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc4I__nrcvde < (nsnte + 0));
              Proc4I__next_nrcvde = (Proc4I__nrcvde + 1);
          ::  Proc4I__next_nrcvde = Proc4I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc4I__next_nrcvde <= 10));
        if
          ::  (Proc4I__nrcvdr < (nsntr + 0));
              Proc4I__next_nrcvdr = (Proc4I__nrcvdr + 1);
          ::  Proc4I__next_nrcvdr = Proc4I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc4I__next_nrcvdr <= 10));
        if
          ::  (Proc4I__pc == 1);
              Proc4I__next_pc = 2;
          ::  ((Proc4I__pc == 0) && ((Proc4I__next_nrcvde >= 7) ||
                (Proc4I__next_nrcvdr >= 4)));
              Proc4I__next_pc = 2;
          ::  ((Proc4I__pc == 2) && ((Proc4I__next_nrcvde >= 7) ||
                (Proc4I__next_nrcvdr >= 4)));
              Proc4I__next_pc = 3;
          ::  ((Proc4I__pc == 3) && (Proc4I__next_nrcvdr >= 7));
              Proc4I__next_pc = 4;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc5I__nrcvde < (nsnte + 0));
              Proc5I__next_nrcvde = (Proc5I__nrcvde + 1);
          ::  Proc5I__next_nrcvde = Proc5I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc5I__next_nrcvde <= 10));
        if
          ::  (Proc5I__nrcvdr < (nsntr + 0));
              Proc5I__next_nrcvdr = (Proc5I__nrcvdr + 1);
          ::  Proc5I__next_nrcvdr = Proc5I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc5I__next_nrcvdr <= 10));
        if
          ::  (Proc5I__pc == 1);
              Proc5I__next_pc = 2;
          ::  ((Proc5I__pc == 0) && ((Proc5I__next_nrcvde >= 7) ||
                (Proc5I__next_nrcvdr >= 4)));
              Proc5I__next_pc = 2;
          ::  ((Proc5I__pc == 2) && ((Proc5I__next_nrcvde >= 7) ||
                (Proc5I__next_nrcvdr >= 4)));
              Proc5I__next_pc = 3;
          ::  ((Proc5I__pc == 3) && (Proc5I__next_nrcvdr >= 7));
              Proc5I__next_pc = 4;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc6I__nrcvde < (nsnte + 0));
              Proc6I__next_nrcvde = (Proc6I__nrcvde + 1);
          ::  Proc6I__next_nrcvde = Proc6I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc6I__next_nrcvde <= 10));
        if
          ::  (Proc6I__nrcvdr < (nsntr + 0));
              Proc6I__next_nrcvdr = (Proc6I__nrcvdr + 1);
          ::  Proc6I__next_nrcvdr = Proc6I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc6I__next_nrcvdr <= 10));
        if
          ::  (Proc6I__pc == 1);
              Proc6I__next_pc = 2;
          ::  ((Proc6I__pc == 0) && ((Proc6I__next_nrcvde >= 7) ||
                (Proc6I__next_nrcvdr >= 4)));
              Proc6I__next_pc = 2;
          ::  ((Proc6I__pc == 2) && ((Proc6I__next_nrcvde >= 7) ||
                (Proc6I__next_nrcvdr >= 4)));
              Proc6I__next_pc = 3;
          ::  ((Proc6I__pc == 3) && (Proc6I__next_nrcvdr >= 7));
              Proc6I__next_pc = 4;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc7I__nrcvde < (nsnte + 0));
              Proc7I__next_nrcvde = (Proc7I__nrcvde + 1);
          ::  Proc7I__next_nrcvde = Proc7I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc7I__next_nrcvde <= 10));
        if
          ::  (Proc7I__nrcvdr < (nsntr + 0));
              Proc7I__next_nrcvdr = (Proc7I__nrcvdr + 1);
          ::  Proc7I__next_nrcvdr = Proc7I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc7I__next_nrcvdr <= 10));
        if
          ::  (Proc7I__pc == 1);
              Proc7I__next_pc = 2;
          ::  ((Proc7I__pc == 0) && ((Proc7I__next_nrcvde >= 7) ||
                (Proc7I__next_nrcvdr >= 4)));
              Proc7I__next_pc = 2;
          ::  ((Proc7I__pc == 2) && ((Proc7I__next_nrcvde >= 7) ||
                (Proc7I__next_nrcvdr >= 4)));
              Proc7I__next_pc = 3;
          ::  ((Proc7I__pc == 3) && (Proc7I__next_nrcvdr >= 7));
              Proc7I__next_pc = 4;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc8I__nrcvde < (nsnte + 0));
              Proc8I__next_nrcvde = (Proc8I__nrcvde + 1);
          ::  Proc8I__next_nrcvde = Proc8I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc8I__next_nrcvde <= 10));
        if
          ::  (Proc8I__nrcvdr < (nsntr + 0));
              Proc8I__next_nrcvdr = (Proc8I__nrcvdr + 1);
          ::  Proc8I__next_nrcvdr = Proc8I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc8I__next_nrcvdr <= 10));
        if
          ::  (Proc8I__pc == 1);
              Proc8I__next_pc = 2;
          ::  ((Proc8I__pc == 0) && ((Proc8I__next_nrcvde >= 7) ||
                (Proc8I__next_nrcvdr >= 4)));
              Proc8I__next_pc = 2;
          ::  ((Proc8I__pc == 2) && ((Proc8I__next_nrcvde >= 7) ||
                (Proc8I__next_nrcvdr >= 4)));
              Proc8I__next_pc = 3;
          ::  ((Proc8I__pc == 3) && (Proc8I__next_nrcvdr >= 7));
              Proc8I__next_pc = 4;
            :: else ->
...
int Proc9I__nrcvde = 0;
int Proc9I__next_nrcvde = 0;
int Proc9I__nrcvdr = 0;
int Proc9I__next_nrcvdr = 0;
...
_lab13:
  if
    ::  atomic {
        if
          ::  (Proc9I__nrcvde < (nsnte + 0));
              Proc9I__next_nrcvde = (Proc9I__nrcvde + 1);
          ::  Proc9I__next_nrcvde = Proc9I__nrcvde;
        fi;
        /* (nrcvde <= (nsnte + F)) */
        assert((Proc9I__next_nrcvde <= 10));
        if
          ::  (Proc9I__nrcvdr < (nsntr + 0));
              Proc9I__next_nrcvdr = (Proc9I__nrcvdr + 1);
          ::  Proc9I__next_nrcvdr = Proc9I__nrcvdr;
        fi;
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc9I__next_nrcvdr <= 10));
        if
          ::  (Proc9I__pc == 1);
              Proc9I__next_pc = 2;
          ::  ((Proc9I__pc == 0) && ((Proc9I__next_nrcvde >= 7) ||
                (Proc9I__next_nrcvdr >= 4)));
              Proc9I__next_pc = 2;
          ::  ((Proc9I__pc == 2) && ((Proc9I__next_nrcvde >= 7) ||
                (Proc9I__next_nrcvdr >= 4)));
              Proc9I__next_pc = 3;
          ::  ((Proc9I__pc == 3) && (Proc9I__next_nrcvdr >= 7));
              Proc9I__next_pc = 4;
            :: else ->
Proc9I__next_pc = Proc9I__pc;
        fi;
        if
          ::  (((Proc9I__pc == 0) || (Proc9I__pc == 1)) && (Proc9I__next_pc
                == 2));
              nsnte = (nsnte + 1);
        ...
        Proc9I__nrcvde = Proc9I__next_nrcvde;
        Proc9I__nrcvdr = Proc9I__next_nrcvdr;
        printf("STEP: pc=%d; nrcvde=%d; nrcvdr=%d; nsnte=%d; nsntr=%d\n",
          Proc9I__pc, Proc9I__nrcvde, Proc9I__nrcvdr, nsnte, nsntr);
        Proc9I__next_pc = 0;
        Proc9I__next_nrcvde = 0;
        Proc9I__next_nrcvdr = 0;
      }
  fi;
  goto _lab13;
_lab4:
