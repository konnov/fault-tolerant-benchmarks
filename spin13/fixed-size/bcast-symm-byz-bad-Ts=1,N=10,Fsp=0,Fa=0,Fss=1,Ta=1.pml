...
#define all_acc ((((((((((((Proc0I__pc == 3) && (Proc1I__pc == 3)) &&\
  ...
  (Proc5I__pc == 3)) && (Proc6I__pc == 3)) && (Proc7I__pc == 3)) &&\
  (Proc8I__pc == 3)) && (Proc9I__pc == 3))))
#define in_transit ((((((((((((Proc0I__nrcvd < ((nsnt + 1) + 0)) ||\
  (Proc1I__nrcvd < ((nsnt + 1) + 0))) || (Proc2I__nrcvd < ((nsnt + 1) + 0)))\
  || (Proc3I__nrcvd < ((nsnt + 1) + 0))) || (Proc4I__nrcvd < ((nsnt + 1) +\
  0))) || (Proc5I__nrcvd < ((nsnt + 1) + 0))) || (Proc6I__nrcvd < ((nsnt + 1)\
  + 0))) || (Proc7I__nrcvd < ((nsnt + 1) + 0))) || (Proc8I__nrcvd < ((nsnt +\
  1) + 0))) || (Proc9I__nrcvd < ((nsnt + 1) + 0)))))
#define tx_inv (((0 == nsnt)))
#define symm_inv (((((0 == 0) && (nsnt >= 0)) || ( ! ((nsnt + 1) < 3)))))
/* (N > 3) */
/* (Fss >= 0) */
/* (Fsp >= 0) */
/* (Fa >= 0) */
