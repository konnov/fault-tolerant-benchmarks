...
#define in_transit (((((((Proc0I__nrcvd < ((nsnt + 1) + 4)) || (Proc1I__nrcvd\
  < ((nsnt + 1) + 4))) || (Proc2I__nrcvd < ((nsnt + 1) + 4))) ||\
  (Proc3I__nrcvd < ((nsnt + 1) + 4))) || (Proc4I__nrcvd < ((nsnt + 1) +\
  4)))))
