...
#define all_acc ((((((((((((Proc0I__pc == 3) && (Proc1I__pc == 3)) &&\
  ...
  (Proc5I__pc == 3)) && (Proc6I__pc == 3)) && (Proc7I__pc == 3)) &&\
  (Proc8I__pc == 3)) && (Proc9I__pc == 3))))
#define in_transit (((((((((((((Proc0I__nrcvd + 5) < nsnt) || ((Proc1I__nrcvd\
  + 5) < nsnt)) || ((Proc2I__nrcvd + 5) < nsnt)) || ((Proc3I__nrcvd + 5) <\
  nsnt)) || ((Proc4I__nrcvd + 5) < nsnt)) || ((Proc5I__nrcvd + 5) < nsnt)) ||\
  ((Proc6I__nrcvd + 5) < nsnt)) || ((Proc7I__nrcvd + 5) < nsnt)) ||\
  ((Proc8I__nrcvd + 5) < nsnt)) || ((Proc9I__nrcvd + 5) < nsnt))))
