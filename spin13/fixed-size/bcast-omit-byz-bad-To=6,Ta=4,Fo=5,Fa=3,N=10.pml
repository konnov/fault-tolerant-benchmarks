  ...
  if
    ::  atomic {
        ...
        if
          ::  (Proc1I__next_nrcvd >= 0);
              Proc1I__next_pc = 3;
          ::  ((Proc1I__next_nrcvd < 0) && ((Proc1I__pc == 1) ||
  ...
  if
    ::  atomic {
        ...
        if
          ::  (Proc2I__next_nrcvd >= 0);
              Proc2I__next_pc = 3;
          ::  ((Proc2I__next_nrcvd < 0) && ((Proc2I__pc == 1) ||
  ...
  if
    ::  atomic {
        ...
        if
          ::  (Proc3I__next_nrcvd >= 0);
              Proc3I__next_pc = 3;
          ::  ((Proc3I__next_nrcvd < 0) && ((Proc3I__pc == 1) ||
  ...
  if
    ::  atomic {
        ...
        if
          ::  (Proc4I__next_nrcvd >= 0);
              Proc4I__next_pc = 3;
          ::  ((Proc4I__next_nrcvd < 0) && ((Proc4I__pc == 1) ||
  ...
  if
    ::  atomic {
        ...
        if
          ::  (Proc5I__next_nrcvd >= 0);
              Proc5I__next_pc = 3;
          ::  ((Proc5I__next_nrcvd < 0) && ((Proc5I__pc == 1) ||
  ...
  if
    ::  atomic {
        ...
        if
          ::  (Proc6I__next_nrcvd >= 0);
              Proc6I__next_pc = 3;
          ::  ((Proc6I__next_nrcvd < 0) && ((Proc6I__pc == 1) ||
