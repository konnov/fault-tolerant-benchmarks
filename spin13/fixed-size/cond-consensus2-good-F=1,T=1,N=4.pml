...
#define ex_acc1 ((((((Proc0I__pc == 7) || (Proc1I__pc == 7)) || (Proc2I__pc\
  == 7)) || (Proc3I__pc == 7))))
#define prec_init ((((init0 + init1) == 4)))
#define cond_init ((((init0 > (init1 + 1)) || (init1 > (init0 + 1)))))
#define all_acc ((((((((Proc0I__pc == 8) || (Proc0I__pc == 6)) || (Proc0I__pc\
  == 7)) && (((Proc1I__pc == 8) || (Proc1I__pc == 6)) || (Proc1I__pc == 7)))\
  && (((Proc2I__pc == 8) || (Proc2I__pc == 6)) || (Proc2I__pc == 7))) &&\
  (((Proc3I__pc == 8) || (Proc3I__pc == 6)) || (Proc3I__pc == 7)))))
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc0I__pc == 3) || (Proc0I__pc == 4));
              Proc0I__next_pc = 5;
          ::  ((Proc0I__pc == 5) && (Proc0I__next_nrcvd10 >= 2));
              Proc0I__next_pc = 6;
          ::  ((Proc0I__pc == 5) && (Proc0I__next_nrcvd11 >= 2));
              Proc0I__next_pc = 7;
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc1I__pc == 3) || (Proc1I__pc == 4));
              Proc1I__next_pc = 5;
          ::  ((Proc1I__pc == 5) && (Proc1I__next_nrcvd10 >= 2));
              Proc1I__next_pc = 6;
          ::  ((Proc1I__pc == 5) && (Proc1I__next_nrcvd11 >= 2));
              Proc1I__next_pc = 7;
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc2I__pc == 3) || (Proc2I__pc == 4));
              Proc2I__next_pc = 5;
          ::  ((Proc2I__pc == 5) && (Proc2I__next_nrcvd10 >= 2));
              Proc2I__next_pc = 6;
          ::  ((Proc2I__pc == 5) && (Proc2I__next_nrcvd11 >= 2));
              Proc2I__next_pc = 7;
    ...
    ::  atomic {
        ...
        if
          ...
          ::  ((Proc3I__pc == 3) || (Proc3I__pc == 4));
              Proc3I__next_pc = 5;
          ::  ((Proc3I__pc == 5) && (Proc3I__next_nrcvd10 >= 2));
              Proc3I__next_pc = 6;
          ::  ((Proc3I__pc == 5) && (Proc3I__next_nrcvd11 >= 2));
              Proc3I__next_pc = 7;
