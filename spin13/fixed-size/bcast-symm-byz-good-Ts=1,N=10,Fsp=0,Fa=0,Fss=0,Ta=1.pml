...
#define all_acc ((((((((((((Proc0I__pc == 3) && (Proc1I__pc == 3)) &&\
  ...
  (Proc5I__pc == 3)) && (Proc6I__pc == 3)) && (Proc7I__pc == 3)) &&\
  (Proc8I__pc == 3)) && (Proc9I__pc == 3))))
#define in_transit ((((((((((((Proc0I__nrcvd < ((nsnt + 0) + 0)) ||\
  (Proc1I__nrcvd < ((nsnt + 0) + 0))) || (Proc2I__nrcvd < ((nsnt + 0) + 0)))\
  || (Proc3I__nrcvd < ((nsnt + 0) + 0))) || (Proc4I__nrcvd < ((nsnt + 0) +\
  0))) || (Proc5I__nrcvd < ((nsnt + 0) + 0))) || (Proc6I__nrcvd < ((nsnt + 0)\
  + 0))) || (Proc7I__nrcvd < ((nsnt + 0) + 0))) || (Proc8I__nrcvd < ((nsnt +\
  0) + 0))) || (Proc9I__nrcvd < ((nsnt + 0) + 0)))))
#define tx_inv (((0 == nsnt)))
#define symm_inv (((((0 == 0) && (nsnt >= 0)) || ( ! ((nsnt + 0) < 3)))))
/* (N > 3) */
/* (Fss >= 0) */
/* (Fsp >= 0) */
/* (Fa >= 0) */
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc0I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc0I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc0I__next_nrcvd >= 8);
              Proc0I__next_pc = 3;
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc1I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc1I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc1I__next_nrcvd >= 8);
              Proc1I__next_pc = 3;
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc2I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc2I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc2I__next_nrcvd >= 8);
              Proc2I__next_pc = 3;
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc3I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc3I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc3I__next_nrcvd >= 8);
              Proc3I__next_pc = 3;
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc4I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc4I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc4I__next_nrcvd >= 8);
              Proc4I__next_pc = 3;
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc5I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc5I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc5I__next_nrcvd >= 8);
              Proc5I__next_pc = 3;
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc6I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc6I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc6I__next_nrcvd >= 8);
              Proc6I__next_pc = 3;
  ...
  if
    ::  atomic {
        if
          ...
          ::  Proc7I__next_nrcvd = Proc7I__nrcvd;
        fi;
        if
          ::  ( ! (Proc7I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc7I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc7I__next_nrcvd >= 8);
              Proc7I__next_pc = 3;
  ...
  if
    ::  atomic {
        if
          ...
          ::  Proc8I__next_nrcvd = Proc8I__nrcvd;
        fi;
        if
          ::  ( ! (Proc8I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc8I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc8I__next_nrcvd >= 8);
              Proc8I__next_pc = 3;
  ...
  if
    ::  atomic {
        if
          ...
          ::  Proc9I__next_nrcvd = Proc9I__nrcvd;
        fi;
        if
          ::  ( ! (Proc9I__next_nrcvd <= ((nsnt + 0) + 0)));
              Proc9I__next_nrcvd = 0;
              goto end;
            :: else 
        fi;
        if
          ::  (Proc9I__next_nrcvd >= 8);
              Proc9I__next_pc = 3;
