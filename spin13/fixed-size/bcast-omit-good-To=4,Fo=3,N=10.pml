    ...
    ::  atomic {
        ...
        if
          ::  (Proc0I__next_nrcvd >= 5);
              Proc0I__next_pc = 3;
          ::  ((Proc0I__next_nrcvd >= 1) && (Proc0I__next_nrcvd < 5));
              Proc0I__next_pc = 2;
          ::  (Proc0I__pc == 1);
              Proc0I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc1I__next_nrcvd >= 5);
              Proc1I__next_pc = 3;
          ::  ((Proc1I__next_nrcvd >= 1) && (Proc1I__next_nrcvd < 5));
              Proc1I__next_pc = 2;
          ::  (Proc1I__pc == 1);
              Proc1I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc2I__next_nrcvd >= 5);
              Proc2I__next_pc = 3;
          ::  ((Proc2I__next_nrcvd >= 1) && (Proc2I__next_nrcvd < 5));
              Proc2I__next_pc = 2;
          ::  (Proc2I__pc == 1);
              Proc2I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc3I__next_nrcvd >= 5);
              Proc3I__next_pc = 3;
          ::  ((Proc3I__next_nrcvd >= 1) && (Proc3I__next_nrcvd < 5));
              Proc3I__next_pc = 2;
          ::  (Proc3I__pc == 1);
              Proc3I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc4I__next_nrcvd >= 5);
              Proc4I__next_pc = 3;
          ::  ((Proc4I__next_nrcvd >= 1) && (Proc4I__next_nrcvd < 5));
              Proc4I__next_pc = 2;
          ::  (Proc4I__pc == 1);
              Proc4I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc5I__next_nrcvd >= 5);
              Proc5I__next_pc = 3;
          ::  ((Proc5I__next_nrcvd >= 1) && (Proc5I__next_nrcvd < 5));
              Proc5I__next_pc = 2;
          ::  (Proc5I__pc == 1);
              Proc5I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc6I__next_nrcvd >= 5);
              Proc6I__next_pc = 3;
          ::  ((Proc6I__next_nrcvd >= 1) && (Proc6I__next_nrcvd < 5));
              Proc6I__next_pc = 2;
          ::  (Proc6I__pc == 1);
              Proc6I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc7I__next_nrcvd >= 5);
              Proc7I__next_pc = 3;
          ::  ((Proc7I__next_nrcvd >= 1) && (Proc7I__next_nrcvd < 5));
              Proc7I__next_pc = 2;
          ::  (Proc7I__pc == 1);
              Proc7I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc8I__next_nrcvd >= 5);
              Proc8I__next_pc = 3;
          ::  ((Proc8I__next_nrcvd >= 1) && (Proc8I__next_nrcvd < 5));
              Proc8I__next_pc = 2;
          ::  (Proc8I__pc == 1);
              Proc8I__next_pc = 2;
            :: else ->
    ...
    ::  atomic {
        ...
        if
          ::  (Proc9I__next_nrcvd >= 5);
              Proc9I__next_pc = 3;
          ::  ((Proc9I__next_nrcvd >= 1) && (Proc9I__next_nrcvd < 5));
              Proc9I__next_pc = 2;
          ::  (Proc9I__pc == 1);
              Proc9I__next_pc = 2;
            :: else ->
