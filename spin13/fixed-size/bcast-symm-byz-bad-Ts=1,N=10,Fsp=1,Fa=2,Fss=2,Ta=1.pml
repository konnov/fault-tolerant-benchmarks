...
#define in_transit (((((((((Proc0I__nrcvd < ((nsnt + 2) + 2)) ||\
  (Proc1I__nrcvd < ((nsnt + 2) + 2))) || (Proc2I__nrcvd < ((nsnt + 2) + 2)))\
  || (Proc3I__nrcvd < ((nsnt + 2) + 2))) || (Proc4I__nrcvd < ((nsnt + 2) +\
  2))) || (Proc5I__nrcvd < ((nsnt + 2) + 2))) || (Proc6I__nrcvd < ((nsnt + 2)\
  + 2)))))
