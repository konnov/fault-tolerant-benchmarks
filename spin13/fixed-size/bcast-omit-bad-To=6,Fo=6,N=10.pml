...
#define all_acc ((((((((((((Proc0I__pc == 3) && (Proc1I__pc == 3)) &&\
  ...
  (Proc5I__pc == 3)) && (Proc6I__pc == 3)) && (Proc7I__pc == 3)) &&\
  (Proc8I__pc == 3)) && (Proc9I__pc == 3))))
#define in_transit ((((((((((((Proc0I__nrcvd < (nsnt - 6)) || (Proc1I__nrcvd\
  < (nsnt - 6))) || (Proc2I__nrcvd < (nsnt - 6))) || (Proc3I__nrcvd < (nsnt -\
  6))) || (Proc4I__nrcvd < (nsnt - 6))) || (Proc5I__nrcvd < (nsnt - 6))) ||\
  (Proc6I__nrcvd < (nsnt - 6))) || (Proc7I__nrcvd < (nsnt - 6))) ||\
  (Proc8I__nrcvd < (nsnt - 6))) || (Proc9I__nrcvd < (nsnt - 6)))))
#define some_ri ((((((((((((Proc0I__pc == 1) || (Proc1I__pc == 1)) ||\
  (Proc2I__pc == 1)) || (Proc3I__pc == 1)) || (Proc4I__pc == 1)) ||\
  (Proc5I__pc == 1)) || (Proc6I__pc == 1)) || (Proc7I__pc == 1)) ||\
  (Proc8I__pc == 1)) || (Proc9I__pc == 1))))
#define no_ri ((((((((((((Proc0I__pc != 1) && (Proc1I__pc != 1)) &&\
  (Proc2I__pc != 1)) && (Proc3I__pc != 1)) && (Proc4I__pc != 1)) &&\
  (Proc5I__pc != 1)) && (Proc6I__pc != 1)) && (Proc7I__pc != 1)) &&\
  (Proc8I__pc != 1)) && (Proc9I__pc != 1))))
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc0I__next_nrcvd <= nsnt));
              Proc0I__next_nrcvd = Proc0I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc0I__next_nrcvd >= 7);
              Proc0I__next_pc = 3;
          ::  ((Proc0I__next_nrcvd >= 1) && (Proc0I__next_nrcvd < 7));
              Proc0I__next_pc = 2;
          ::  (Proc0I__pc == 1);
              Proc0I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc1I__next_nrcvd <= nsnt));
              Proc1I__next_nrcvd = Proc1I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc1I__next_nrcvd >= 7);
              Proc1I__next_pc = 3;
          ::  ((Proc1I__next_nrcvd >= 1) && (Proc1I__next_nrcvd < 7));
              Proc1I__next_pc = 2;
          ::  (Proc1I__pc == 1);
              Proc1I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc2I__next_nrcvd <= nsnt));
              Proc2I__next_nrcvd = Proc2I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc2I__next_nrcvd >= 7);
              Proc2I__next_pc = 3;
          ::  ((Proc2I__next_nrcvd >= 1) && (Proc2I__next_nrcvd < 7));
              Proc2I__next_pc = 2;
          ::  (Proc2I__pc == 1);
              Proc2I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc3I__next_nrcvd <= nsnt));
              Proc3I__next_nrcvd = Proc3I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc3I__next_nrcvd >= 7);
              Proc3I__next_pc = 3;
          ::  ((Proc3I__next_nrcvd >= 1) && (Proc3I__next_nrcvd < 7));
              Proc3I__next_pc = 2;
          ::  (Proc3I__pc == 1);
              Proc3I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc4I__next_nrcvd <= nsnt));
              Proc4I__next_nrcvd = Proc4I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc4I__next_nrcvd >= 7);
              Proc4I__next_pc = 3;
          ::  ((Proc4I__next_nrcvd >= 1) && (Proc4I__next_nrcvd < 7));
              Proc4I__next_pc = 2;
          ::  (Proc4I__pc == 1);
              Proc4I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc5I__next_nrcvd <= nsnt));
              Proc5I__next_nrcvd = Proc5I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc5I__next_nrcvd >= 7);
              Proc5I__next_pc = 3;
          ::  ((Proc5I__next_nrcvd >= 1) && (Proc5I__next_nrcvd < 7));
              Proc5I__next_pc = 2;
          ::  (Proc5I__pc == 1);
              Proc5I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc6I__next_nrcvd <= nsnt));
              Proc6I__next_nrcvd = Proc6I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc6I__next_nrcvd >= 7);
              Proc6I__next_pc = 3;
          ::  ((Proc6I__next_nrcvd >= 1) && (Proc6I__next_nrcvd < 7));
              Proc6I__next_pc = 2;
          ::  (Proc6I__pc == 1);
              Proc6I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc7I__next_nrcvd <= nsnt));
              Proc7I__next_nrcvd = Proc7I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc7I__next_nrcvd >= 7);
              Proc7I__next_pc = 3;
          ::  ((Proc7I__next_nrcvd >= 1) && (Proc7I__next_nrcvd < 7));
              Proc7I__next_pc = 2;
          ::  (Proc7I__pc == 1);
              Proc7I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc8I__next_nrcvd <= nsnt));
              Proc8I__next_nrcvd = Proc8I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc8I__next_nrcvd >= 7);
              Proc8I__next_pc = 3;
          ::  ((Proc8I__next_nrcvd >= 1) && (Proc8I__next_nrcvd < 7));
              Proc8I__next_pc = 2;
          ::  (Proc8I__pc == 1);
              Proc8I__next_pc = 2;
            :: else ->
...
_lab13:
  if
    ::  atomic {
        ...
        if
          ::  ( ! (Proc9I__next_nrcvd <= nsnt));
              Proc9I__next_nrcvd = Proc9I__nrcvd;
            :: else 
        fi;
        if
          ::  (Proc9I__next_nrcvd >= 7);
              Proc9I__next_pc = 3;
          ::  ((Proc9I__next_nrcvd >= 1) && (Proc9I__next_nrcvd < 7));
              Proc9I__next_pc = 2;
          ::  (Proc9I__pc == 1);
              Proc9I__next_pc = 2;
            :: else ->
