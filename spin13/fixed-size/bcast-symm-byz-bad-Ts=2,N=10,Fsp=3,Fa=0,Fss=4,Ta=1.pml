...
#define in_transit (((((((((Proc0I__nrcvd < ((nsnt + 4) + 0)) ||\
  (Proc1I__nrcvd < ((nsnt + 4) + 0))) || (Proc2I__nrcvd < ((nsnt + 4) + 0)))\
  || (Proc3I__nrcvd < ((nsnt + 4) + 0))) || (Proc4I__nrcvd < ((nsnt + 4) +\
  0))) || (Proc5I__nrcvd < ((nsnt + 4) + 0))) || (Proc6I__nrcvd < ((nsnt + 4)\
  + 0)))))
#define tx_inv (((0 == nsnt)))
#define symm_inv (((((0 == 0) && (nsnt >= 0)) || ( ! ((nsnt + 4) < 4)))))
/* (N > 3) */
/* (Fss >= 0) */
/* (Fsp >= 0) */
/* (Fa >= 0) */
