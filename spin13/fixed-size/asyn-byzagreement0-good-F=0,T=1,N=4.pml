...
_lab13:
  if
    ::  atomic {
        ...
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc1I__next_nrcvdr <= 4));
        if
          ::  (Proc1I__pc == 1);
              Proc1I__next_pc = 2;
          ::  ((Proc1I__pc == 0) && ((Proc1I__next_nrcvde >= 3) ||
                (Proc1I__next_nrcvdr >= 2)));
              Proc1I__next_pc = 2;
          ::  ((Proc1I__pc == 2) && ((Proc1I__next_nrcvde >= 3) ||
                (Proc1I__next_nrcvdr >= 2)));
              Proc1I__next_pc = 3;
...
_lab13:
  if
    ::  atomic {
        ...
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc2I__next_nrcvdr <= 4));
        if
          ::  (Proc2I__pc == 1);
              Proc2I__next_pc = 2;
          ::  ((Proc2I__pc == 0) && ((Proc2I__next_nrcvde >= 3) ||
                (Proc2I__next_nrcvdr >= 2)));
              Proc2I__next_pc = 2;
          ::  ((Proc2I__pc == 2) && ((Proc2I__next_nrcvde >= 3) ||
                (Proc2I__next_nrcvdr >= 2)));
              Proc2I__next_pc = 3;
...
_lab13:
  if
    ::  atomic {
        ...
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc3I__next_nrcvdr <= 4));
        if
          ::  (Proc3I__pc == 1);
              Proc3I__next_pc = 2;
          ::  ((Proc3I__pc == 0) && ((Proc3I__next_nrcvde >= 3) ||
                (Proc3I__next_nrcvdr >= 2)));
              Proc3I__next_pc = 2;
          ::  ((Proc3I__pc == 2) && ((Proc3I__next_nrcvde >= 3) ||
                (Proc3I__next_nrcvdr >= 2)));
              Proc3I__next_pc = 3;
