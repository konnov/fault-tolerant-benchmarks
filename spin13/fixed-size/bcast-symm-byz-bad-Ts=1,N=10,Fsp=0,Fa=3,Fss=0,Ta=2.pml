...
#define in_transit (((((((((Proc0I__nrcvd < ((nsnt + 0) + 3)) ||\
  (Proc1I__nrcvd < ((nsnt + 0) + 3))) || (Proc2I__nrcvd < ((nsnt + 0) + 3)))\
  || (Proc3I__nrcvd < ((nsnt + 0) + 3))) || (Proc4I__nrcvd < ((nsnt + 0) +\
  3))) || (Proc5I__nrcvd < ((nsnt + 0) + 3))) || (Proc6I__nrcvd < ((nsnt + 0)\
  + 3)))))
