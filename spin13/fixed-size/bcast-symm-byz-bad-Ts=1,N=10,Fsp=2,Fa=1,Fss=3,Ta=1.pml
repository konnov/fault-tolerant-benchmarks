...
#define in_transit (((((((((Proc0I__nrcvd < ((nsnt + 3) + 1)) ||\
  (Proc1I__nrcvd < ((nsnt + 3) + 1))) || (Proc2I__nrcvd < ((nsnt + 3) + 1)))\
  || (Proc3I__nrcvd < ((nsnt + 3) + 1))) || (Proc4I__nrcvd < ((nsnt + 3) +\
  1))) || (Proc5I__nrcvd < ((nsnt + 3) + 1))) || (Proc6I__nrcvd < ((nsnt + 3)\
  + 1)))))
