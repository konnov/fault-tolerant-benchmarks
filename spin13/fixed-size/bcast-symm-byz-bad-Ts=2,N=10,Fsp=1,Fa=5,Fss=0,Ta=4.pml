...
#define all_acc ((((((Proc0I__pc == 3) && (Proc1I__pc == 3)) && (Proc2I__pc\
  == 3)) && (Proc3I__pc == 3))))
#define in_transit ((((((Proc0I__nrcvd < ((nsnt + 0) + 5)) || (Proc1I__nrcvd\
  < ((nsnt + 0) + 5))) || (Proc2I__nrcvd < ((nsnt + 0) + 5))) ||\
  (Proc3I__nrcvd < ((nsnt + 0) + 5)))))
