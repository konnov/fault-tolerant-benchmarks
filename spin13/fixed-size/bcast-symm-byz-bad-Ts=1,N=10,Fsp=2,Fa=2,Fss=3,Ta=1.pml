...
#define all_acc ((((((((Proc0I__pc == 3) && (Proc1I__pc == 3)) && (Proc2I__pc\
  == 3)) && (Proc3I__pc == 3)) && (Proc4I__pc == 3)) && (Proc5I__pc == 3))))
#define in_transit ((((((((Proc0I__nrcvd < ((nsnt + 3) + 2)) ||\
  (Proc1I__nrcvd < ((nsnt + 3) + 2))) || (Proc2I__nrcvd < ((nsnt + 3) + 2)))\
  || (Proc3I__nrcvd < ((nsnt + 3) + 2))) || (Proc4I__nrcvd < ((nsnt + 3) +\
  2))) || (Proc5I__nrcvd < ((nsnt + 3) + 2)))))
