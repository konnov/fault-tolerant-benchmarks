...
_lab13:
  if
    ::  atomic {
        ...
        /* (nrcvdr <= (nsntr + F)) */
        assert((Proc5I__next_nrcvdr <= 6));
        if
          ::  (Proc5I__pc == 1);
              Proc5I__next_pc = 2;
          ::  ((Proc5I__pc == 0) && ((Proc5I__next_nrcvde >= 5) ||
                (Proc5I__next_nrcvdr >= 4)));
              Proc5I__next_pc = 2;
          ::  ((Proc5I__pc == 2) && ((Proc5I__next_nrcvde >= 5) ||
                (Proc5I__next_nrcvdr >= 4)));
              Proc5I__next_pc = 3;
