...
#define no_ri ((((((((((((Proc0I__pc != 1) && (Proc1I__pc != 1)) &&\
  ...
  (Proc5I__pc != 1)) && (Proc6I__pc != 1)) && (Proc7I__pc != 1)) &&\
  (Proc8I__pc != 1)) && (Proc9I__pc != 1))))
#define in_transit ((((((((((((Proc0I__nrcvd < (nsnt - 9)) || (Proc1I__nrcvd\
  < (nsnt - 9))) || (Proc2I__nrcvd < (nsnt - 9))) || (Proc3I__nrcvd < (nsnt -\
  9))) || (Proc4I__nrcvd < (nsnt - 9))) || (Proc5I__nrcvd < (nsnt - 9))) ||\
  (Proc6I__nrcvd < (nsnt - 9))) || (Proc7I__nrcvd < (nsnt - 9))) ||\
  (Proc8I__nrcvd < (nsnt - 9))) || (Proc9I__nrcvd < (nsnt - 9)))))
