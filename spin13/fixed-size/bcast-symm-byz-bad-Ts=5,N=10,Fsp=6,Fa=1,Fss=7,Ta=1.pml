...
#define all_acc (((((Proc0I__pc == 3) && (Proc1I__pc == 3)) && (Proc2I__pc ==\
  3))))
#define in_transit (((((Proc0I__nrcvd < ((nsnt + 7) + 1)) || (Proc1I__nrcvd <\
  ((nsnt + 7) + 1))) || (Proc2I__nrcvd < ((nsnt + 7) + 1)))))
